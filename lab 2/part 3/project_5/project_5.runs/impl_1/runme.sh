...
HD_PWD='T:/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_fun.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_fun.tcl -notrace
