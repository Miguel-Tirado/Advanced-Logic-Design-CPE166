...
HD_PWD='T:/lab3_part_1/lab3_part_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_Counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_Counter.tcl -notrace
